...
public class Cube2 extends BaseGLObject {
    ...
    public Cube2() {
        ...
        indexBuffer = ByteBuffer.allocateDirect(orderVertex.length * 2).order(ByteOrder.nativeOrder()).asShortBuffer();
        indexBuffer.put(orderVertex).position(0);
...
//    }
    ...
    public void draw2GL() {
        Matrix.multiplyMM(modelMatrix, 0, GL2Render.ProjectionMatrix, 0, GL2Render.ViewMatrix, 0);
        Matrix.translateM(modelMatrix, 0, 0.0f, -2.0f, 1.0f);
        GLES20.glUseProgram(program);
