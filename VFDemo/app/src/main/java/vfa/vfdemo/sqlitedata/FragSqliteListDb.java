...
import vfa.vfdemo.fragments.sql.FragSqlQuery;
 ...
 * Sample db
 * List recent file db
 * List file in default folder
 * List file in SDcard(can it)
 * Hoot into another app,(emulator,root devices),Local or Remote
 * Create new db file
 */

public class FragSqliteListDb extends VFFragment {
